...
3. **Número de telas e fluxos da spec** — último recurso se ambos acima estiverem ausentes
...
Se `complexity_hint` não estiver presente no charter, infira pelo número de telas e fluxos da spec.
