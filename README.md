...
Permitir que um único documento de especificação (`PRODUCT_SPEC.md`) seja suficiente para:
...
- **Novo chat iniciando trabalho?** Leia `context/PROJECT_OVERVIEW.md` para carregar o contexto completo sem percorrer todos os .md do repositório.
- **Referência rápida?** Consulte `context/QUICK_REFERENCE.md`.
- **Detalhes**: Veja `context/README.md` para entender o propósito e uso da pasta.
...
- DEPLOYMENT.md
- STATUS.md
- **context/PROJECT_OVERVIEW.md** — Contexto completo para novos chats e onboarding
- **docs/adr/** — Architecture Decision Records (decisões arquiteturais)
- **docs/rfc/** — Request for Comments (propostas formais)
- **docs/AGENTS_CAPABILITIES.md** — Documentação consolidada de agentes
- **docs/PERFORMANCE_METRICS.md** — Targets de latência, cobertura e qualidade

## ✅ Qualidade e Governança

- Definition of Done global e DevOps
- Checklists por stack (React, RN, Backend)
- Testes automatizados e smoke tests pós-deploy
