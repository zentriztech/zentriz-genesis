...
## 1) Entrada
- Spec em `spec/PRODUCT_SPEC.md` com FR/NFR.

## 2) CTO
- Gera `docs/PROJECT_CHARTER.md`.
- Decide PMs necessários (backend/web/mobile/infra).
- Cria `docs/STATUS.md` inicial.
...
- Mantém `reports/QA_REPORT_<area>.md`.
- Bloqueia (FAIL) se requisitos não atendidos.

## 6) Monitor
- Observa histórico de respostas/relatórios.
- Gera `reports/MONITOR_HEALTH_<area>.md` e alerta PM/CTO.
